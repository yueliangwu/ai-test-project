...
var getEastAsianWidth = require("playwright-core/lib/utilsBundle").getEastAsianWidth;
...
var { HttpServer } = require("playwright-core/lib/coreBundle").utils;
...
function startHtmlReportServer(folder) {
  ...
  server.routePrefix("/", (request, response) => {
    ...
    const absolutePath = import_path8.default.join(folder, ...relativePath.split("/"));
